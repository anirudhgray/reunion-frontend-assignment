...
export default function PropertyCard({img = 'house1', price=1800, name="Green Heritage", address = '123 St, Middle of Nowhere, New York', beds = 2, bathrooms = 2,area = {x:5,y:7}}) {
  const header = (
    <img alt="Card" src={require(`../assets/${img}.png`)} onError={(e) => e.target.src=require('../assets/bed.png')} />
  );
  ...
  return (
    <Card className='relative overflow-hidden' footer={footer} header={header}>
